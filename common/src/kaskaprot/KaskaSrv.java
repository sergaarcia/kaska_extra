...
public interface KaskaSrv extends Remote {
    ...
    int commit(String client, Collection <TopicWithOffset> topics) throws RemoteException;

    // recupera offsets guardados por el cliente correspondientes a esos temas
    Collection <TopicWithOffset> committed(String client, Collection <String> topics) throws RemoteException;
